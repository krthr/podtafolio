...
export const analysisSchema = z.object({
  adSegments: z
    .array(
      z.object({
        text: z.string().describe('The exact ad segment text from the transcript'),
  ...
  cleanText: z
    .string()
    .describe('The full transcript with ad segments removed. If no ads found, same as input.'),
  ...
  entities: z
    .array(
      z.object({
        ...
        mentionCount: z.number().describe('Approximate number of times mentioned'),
        contextSnippets: z
          .array(z.string())
          .max(3)
          .describe('Up to 3 short context snippets where the entity is mentioned'),
      }),
    )
  ...
  summary: z.object({
    text: z
      .string()
      .describe('A concise summary of the episode in 2-3 paragraphs, in Spanish'),
    keyPoints: z
      .array(z.string())
