...
- [ ] Queue tables (`queue_jobs`, `queue_schedules`) are created in PostgreSQL _(manual — needs running PG)_
- [ ] Job dispatch and processing work end-to-end _(manual — needs running PG)_
